...
<form action="fangdong.php?a=insert" method="post" name="form1" id="fangdongform1"><!-- form 标签开始 -->
    ...
    <div class="form-item-flex">
        ...
        <div class="form-label-control">
                            ...
                            <input type="text" class="form-control" placeholder="输入账号" style="width:150px;" data-rule-required="true" data-msg-required="请填写账号" remote="ajax.php?checktype=insert&table=fangdong&col=zhanghao" data-msg-remote="内容重复了" id="zhanghao" name="zhanghao" value=""/>                    
        </div>
    ...
    <div class="form-item-flex">
        ...
        <div class="form-label-control">
                            ...
                            <select class="form-control class_xingbie1" data-value="" data-rule-required="true" data-msg-required="请填写性别" id="xingbie" name="xingbie" style="width:250px">
