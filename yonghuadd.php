        ...
        <span class="titles">
            添加用户
                ...
                <div class="panel-body">
                    ...
                    <form action="yonghu.php?a=insert" method="post" name="form1" id="yonghuform1"><!-- form 标签开始 -->
                        ...
                        <div class="form-group form-type-text">
                            <div class="form-item-flex">
                                ...
                                <div class="form-label-control">
                                    ...
                                    <input type="text" class="form-control" placeholder="输入用户名" style="width:150px;"
                                           data-rule-required="true" data-msg-required="请填写用户名"
                                           remote="ajax.php?checktype=insert&table=yonghu&col=yonghuming"
                        ...
                        <div class="form-group form-type-select">
                            <div class="form-item-flex">
                                ...
                                <div class="form-label-control">
                                    ...
                                    <select class="form-control class_xingbie54" data-value="" data-rule-required="true"
                        ...
                        <div class="form-group form-type-text">
                            <div class="form-item-flex">
                                ...
                                <div class="form-label-control">
                                    ...
                                    <input type="text" class="form-control" placeholder="输入邮箱" style="width:150px;"
                                           email="true" data-msg-email="请输入有效邮件地址" id="youxiang" name="youxiang"
                                           value=""/>
                                </div>
                        ...
                        <div class="form-group form-type-text">
                            <div class="form-item-flex">
                                ...
                                <div class="form-label-control">
                                    ...
                                    <input type="text" class="form-control" placeholder="输入年龄" style="width:150px;"
                                           id="nianling" name="nianling" value=""/>
                                </div>
                        ...
                        <div class="form-group form-type-text">
                            <div class="form-item-flex">
                                ...
                                <div class="form-label-control">
                                    ...
                                    <input type="text" class="form-control" placeholder="输入所在城市" style="width:150px;"
                                           id="suozaichengshi" name="suozaichengshi" value=""/>
                                </div>
                        ...
                        <div class="form-group form-type-radio">
                            <div class="form-item-flex">
                                ...
                                <div class="form-label-control">
                                    ...
                                    <div class="class_nianji55" data-value=""><label><input type="radio" id="nianji"
                                                                                            name="nianji" value="本科"/>
                                            本科</label>
                        ...
                        <div class="form-group form-type-text">
                            <div class="form-item-flex">
                                ...
                                <div class="form-label-control">
                                    ...
                                    <input type="text" class="form-control" placeholder="输入学院/专业" style="width:150px;"
                                           id="xueyuanzhuanye" name="xueyuanzhuanye" value=""/>
                                </div>
                        ...
                        <div class="form-group" id="form-item-btn">
                            <div class="form-item-flex">
                                ...
                                <div class="form-label-control">
                                    ...
                                    <input type="hidden" name="issh" value="是"/>
