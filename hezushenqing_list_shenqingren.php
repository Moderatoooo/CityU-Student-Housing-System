...
$sort    = isset($_REQUEST['sort']) ? $_REQUEST['sort'] : 'DESC'; // 获取前台搜索框中 排序类型，默认为倒序
    //  设置为当前用户的数据
    $where .= " AND shenqingren='".$_SESSION["username"]."' ";
...
<div class="form-search pa10 bg-warning">
    <form class="form-inline" action="?" size="small" id="formSearch"><!-- form 标签开始 -->
                   ...
                   类型： <select class="form-control class_leixing16" data-value="<?php echo $_GET["leixing"]; ?>" id="leixing" name="leixing">
...
$(".class_leixing16").val($(".class_leixing16").attr("data-value"))</script>
                   ...
                   设施： <select class="form-control class_sheshi17" data-value="<?php echo $_GET["sheshi"]; ?>" id="sheshi" name="sheshi[]">
...
(function(){
                            ...
                            for(var i=0;i<dataValue.length;i++){
                                $(".class_sheshi17>option[value='"+dataValue[i]+"']").prop("selected" , true);
                            }
                        })()</script>

                    
                   是否有电梯： <select class="form-control class_shifouyoudianti18" data-value="<?php echo $_GET["shifouyoudianti"]; ?>" id="shifouyoudianti" name="shifouyoudianti">
<option value="">请选择</option><option value="是">是</option>
<option value="否">否</option>

</select>
<script>
$(".class_shifouyoudianti18").val($(".class_shifouyoudianti18").attr("data-value"))</script>

                    
                   租赁类型： <select class="form-control class_zulinleixing19" data-value="<?php echo $_GET["zulinleixing"]; ?>" id="zulinleixing" name="zulinleixing">
<option value="">请选择</option><option value="整租">整租</option>
<option value="分租">分租</option>

</select>
<script>
$(".class_zulinleixing19").val($(".class_zulinleixing19").attr("data-value"))</script>
                   ...
                   合租状态： <select class="form-control class_hezuzhuangtai20" data-value="<?php echo $_GET["hezuzhuangtai"]; ?>" id="hezuzhuangtai" name="hezuzhuangtai">
...
<script>
$(".class_hezuzhuangtai20").val($(".class_hezuzhuangtai20").attr("data-value"))</script>
