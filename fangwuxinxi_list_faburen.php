            ...
            <div class="panel-body">
                ...
                <div class="form-search pa10 bg-warning">
                    <form class="form-inline" action="?" size="small" id="formSearch"><!-- form 标签开始 -->
                        ...
                        是否有电梯： <select class="form-control class_shifouyoudianti10"
                        ...
                        <script>
                            $(".class_shifouyoudianti10").val($(".class_shifouyoudianti10").attr("data-value"))</script>


                        租赁类型： <select class="form-control class_zulinleixing11"
                        ...
                        <script>
                            $(".class_zulinleixing11").val($(".class_zulinleixing11").attr("data-value"))</script>


                        价格区间： <select class="form-control class_jiagequjian12"
                        ...
                        <script>
                            $(".class_jiagequjian12").val($(".class_jiagequjian12").attr("data-value"))</script>


                        押金方式： <select class="form-control class_yajinfangshi13"
                        ...
                        <script>
                            $(".class_yajinfangshi13").val($(".class_yajinfangshi13").attr("data-value"))</script>


                        距离学校： <select class="form-control class_julixuexiao14"
                        ...
                        <script>
                            $(".class_julixuexiao14").val($(".class_julixuexiao14").attr("data-value"))</script>


                        房屋状态： <select class="form-control class_fangwuzhuangtai15"
                        ...
                        <script>
                            $(".class_fangwuzhuangtai15").val($(".class_fangwuzhuangtai15").attr("data-value"))</script>


                        设施： <select class="form-control class_sheshi16" data-value="<?php echo $_GET["sheshi"]; ?>"
                        ...
                        <script>
                            (function () {
                                ...
                                for (var i = 0; i < dataValue.length; i++) {
                                    $(".class_sheshi16>option[value='" + dataValue[i] + "']").prop("selected", true);
                                }
                            })()</script>
                            ...
                            <tr id="<?php echo $map["id"]; ?>" pid="">
                                ...
                                <td align="center">
                                    <a class="btn btn-primary btn-xs"
                                       href="fangjianxinxi_add.php?id=<?php echo $map["id"]; ?>"> 添加房间 </a>
