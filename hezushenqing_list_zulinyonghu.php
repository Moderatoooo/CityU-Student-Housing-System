...
<div class="form-search pa10 bg-warning">
    <form class="form-inline" action="?" size="small" id="formSearch"><!-- form 标签开始 -->
                   ...
                   类型： <select class="form-control class_leixing11" data-value="<?php echo $_GET["leixing"]; ?>" id="leixing" name="leixing">
...
$(".class_leixing11").val($(".class_leixing11").attr("data-value"))</script>
                   ...
                   设施： <select class="form-control class_sheshi12" data-value="<?php echo $_GET["sheshi"]; ?>" id="sheshi" name="sheshi[]">
...
(function(){
                   ...
                   是否有电梯： <select class="form-control class_shifouyoudianti13" data-value="<?php echo $_GET["shifouyoudianti"]; ?>" id="shifouyoudianti" name="shifouyoudianti">
...
$(".class_shifouyoudianti13").val($(".class_shifouyoudianti13").attr("data-value"))</script>
                   ...
                   租赁类型： <select class="form-control class_zulinleixing14" data-value="<?php echo $_GET["zulinleixing"]; ?>" id="zulinleixing" name="zulinleixing">
...
$(".class_zulinleixing14").val($(".class_zulinleixing14").attr("data-value"))</script>
                   ...
                   合租状态： <select class="form-control class_hezuzhuangtai15" data-value="<?php echo $_GET["hezuzhuangtai"]; ?>" id="hezuzhuangtai" name="hezuzhuangtai">
...
<script>
$(".class_hezuzhuangtai15").val($(".class_hezuzhuangtai15").attr("data-value"))</script>
...
<a class="btn btn-primary btn-xs" href="shenqingshenhe_add.php?id=<?php echo $map["id"]; ?>"> 申请审核 </a>  
