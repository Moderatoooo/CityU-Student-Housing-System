...
<form action="hezushenqing.php?a=insert" method="post" name="form1" id="hezushenqingform1"><!-- form 标签开始 -->
    ...
    <div class="form-item-flex">
        ...
        <div class="form-label-control">
                            ...
                            <?php  $mapfangwuleixing11 = db()->find("SELECT leixing,id FROM fangwuleixing where id='".$readMap["leixing"]."'");  ?><?php echo $mapfangwuleixing11["leixing"]; ?><input type="hidden" id="leixing" name="leixing" value="<?php echo Info::html($readMap["leixing"]); ?>"/>                    
        </div>
