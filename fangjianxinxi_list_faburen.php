...
<div class="form-search pa10 bg-warning">
    <form class="form-inline" action="?" size="small" id="formSearch"><!-- form 标签开始 -->
                   ...
                   类型： <select class="form-control class_leixing4" data-value="<?php echo $_GET["leixing"]; ?>" id="leixing" name="leixing">
...
<script>
$(".class_leixing4").val($(".class_leixing4").attr("data-value"))</script>
...
$(".class_zulinleixing5").val($(".class_zulinleixing5").attr("data-value"))</script>
                   ...
                   状态： <select class="form-control class_zhuangtai6" data-value="<?php echo $_GET["zhuangtai"]; ?>" id="zhuangtai" name="zhuangtai">
<option value="">请选择</option><option value="待租">待租</option>
<option value="已租">已租</option>

</select>
<script>
$(".class_zhuangtai6").val($(".class_zhuangtai6").attr("data-value"))</script>
