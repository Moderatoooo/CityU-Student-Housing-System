        ...
        <span class="titles">
            ...
            <div class="panel-body">
                ...
                <form action="jilu.php?a=insert" method="post" name="form1" id="jiluform1"><!-- form 标签开始 -->
                    ...
                    <input type="hidden" name="siliaoid" value="<?php echo $_GET["id"]; ?>"/>
                    <div class="form-group form-type-text">
                        <div class="form-item-flex">
                            <label class="form-label-title"> 编号</label>
                            <div class="form-label-control">

                                <?php echo $readMap["bianhao"]; ?><input type="hidden" id="bianhao" name="bianhao"
                                                                         value="<?php echo Info::html($readMap["bianhao"]); ?>"/>
                            </div>
                    ...
                    <div class="form-group form-type-textarea">
                        <div class="form-item-flex">
                            ...
                            <div class="form-label-control">
                                ...
                                <textarea style="width: 80%;height: 120px" class="form-control" placeholder="输入内容"
                                          id="neirong" name="neirong"></textarea>
                            </div>
                    ...
                    <div class="form-group form-type-text-user">
                        <div class="form-item-flex">
                            ...
                            <div class="form-label-control">
                                ...
                                <input type="text" class="form-control" placeholder="输入发送人" style="width:150px;"
                                       readonly="readonly" id="fasongren" name="fasongren"
                    ...
                    <div class="form-group form-type-text">
                        <div class="form-item-flex">
                            ...
                            <div class="form-label-control">
                                ...
                                <input type="text" class="form-control" placeholder="输入cx" style="width:150px;" id="cx"
                                       name="cx" value="<?php echo $_SESSION["cx"]; ?>"/>
                            </div>
