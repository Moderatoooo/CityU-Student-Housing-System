...
<div class="form-search pa10 bg-warning">
    <form class="form-inline" action="?" size="small" id="formSearch"><!-- form 标签开始 -->
                   ...
                   类型： <select class="form-control class_leixing44" data-value="<?php echo $_GET["leixing"]; ?>" id="leixing" name="leixing">
...
<script>
$(".class_leixing44").val($(".class_leixing44").attr("data-value"))</script>

                    
                   姓名： <input type="text" class="form-control" style="" name="xingming" value="<?php echo $_GET["xingming"]; ?>"/>
                    
                   审核结果： <select class="form-control class_shenhejieguo45" data-value="<?php echo $_GET["shenhejieguo"]; ?>" data-rule-required="true" data-msg-required="请填写审核结果" id="shenhejieguo" name="shenhejieguo">
<option value="">请选择</option><option value="已通过">已通过</option>
<option value="未通过">未通过</option>

</select>
<script>
$(".class_shenhejieguo45").val($(".class_shenhejieguo45").attr("data-value"))</script>
                    ...
                    <td width="30" align="center">
                        <label>
                            ...
                            <?php echo $map["mianji"]; ?>                        </td>
                                            <td>
                            <?php  $mapfangwuleixing30 = db()->find("SELECT leixing,id FROM fangwuleixing where id='".$map["leixing"]."'");  ?><?php echo $mapfangwuleixing30["leixing"]; ?>                        </td>
                                            <td>
