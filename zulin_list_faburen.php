            ...
            <div class="panel-body">
                ...
                <div class="form-search pa10 bg-warning">
                    <form class="form-inline" action="?" size="small" id="formSearch"><!-- form 标签开始 -->
                        ...
                        类型： <select class="form-control class_leixing3" data-value="<?php echo $_GET["leixing"]; ?>"
                        ...
                        <script>
                            $(".class_leixing3").val($(".class_leixing3").attr("data-value"))</script>


                        租赁类型： <select class="form-control class_zulinleixing4"
                    ...
                    <table width="100%" border="1" class="table table-list table-bordered table-hover">
                        ...
                        foreach ($lists as $map) {
                            ...
                            <tr id="<?php echo $map["id"]; ?>" pid="">
                                ...
                                <td>
                                    <?php $mapfangwuleixing7 = db()->find("SELECT leixing,id FROM fangwuleixing where id='" . $map["leixing"] . "'"); ?><?php echo $mapfangwuleixing7["leixing"]; ?>                        </td>
                                <td>
                                ...
                                <td align="center">
                                    ...
                                    <?php if ($map["zulinzhuangtai"] == '待审核') { ?>
                                        <a class="btn btn-primary btn-xs"
                                           href="shenhe_add.php?id=<?php echo $map["id"]; ?>"> 添加审核 </a>
