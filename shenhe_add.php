...
<form action="shenhe.php?a=insert" method="post" name="form1" id="shenheform1"><!-- form 标签开始 -->
    
            <input type="hidden" name="zulinid" value="<?php echo $_GET["id"]; ?>"/>                <div class="form-group form-type-text">
    ...
    <div class="form-item-flex">
        ...
        <div class="form-label-control">
                            ...
                            <?php echo $readMap["lianxidianhua"]; ?><input type="hidden" id="lianxidianhua" name="lianxidianhua" value="<?php echo Info::html($readMap["lianxidianhua"]); ?>"/>                    
        </div>
    ...
    <div class="form-item-flex">
        ...
        <div class="form-label-control">
                            ...
                            <?php echo $readMap["shenfenzhenghao"]; ?><input type="hidden" id="shenfenzhenghao" name="shenfenzhenghao" value="<?php echo Info::html($readMap["shenfenzhenghao"]); ?>"/>                    
        </div>
    ...
    <div class="form-item-flex">
        ...
        <div class="form-label-control">
                            ...
                            <?php  $mapfangjianxinxi9 = db()->find("SELECT fangjianmingcheng,id FROM fangjianxinxi where id='".$readMap["xuanzefangjian"]."'");  ?><?php echo $mapfangjianxinxi9["fangjianmingcheng"]; ?><input type="hidden" id="xuanzefangjian" name="xuanzefangjian" value="<?php echo Info::html($readMap["xuanzefangjian"]); ?>"/>                    
        </div>
    ...
    <div class="form-item-flex">
        ...
        <div class="form-label-control">
                            ...
                            <select class="form-control class_shenhe7" data-value="" data-rule-required="true" data-msg-required="请填写审核" id="shenhe" name="shenhe" style="width:250px">
...
<option value="未通过">未通过</option>
    ...
    <div class="form-item-flex">
        ...
        <div class="form-label-control">
                            ...
                            <input type="text" class="form-control" placeholder="输入操作人" style="width:150px;" readonly="readonly" id="caozuoren" name="caozuoren" value="<?php echo $_SESSION["username"]; ?>"/>                    
        </div>
