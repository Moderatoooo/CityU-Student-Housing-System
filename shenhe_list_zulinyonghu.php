...
<div class="form-search pa10 bg-warning">
    <form class="form-inline" action="?" size="small" id="formSearch"><!-- form 标签开始 -->
                   ...
                   租赁类型： <select class="form-control class_zulinleixing3" data-value="<?php echo $_GET["zulinleixing"]; ?>" id="zulinleixing" name="zulinleixing">
...
$(".class_zulinleixing3").val($(".class_zulinleixing3").attr("data-value"))</script>
                   ...
                   审核： <select class="form-control class_shenhe4" data-value="<?php echo $_GET["shenhe"]; ?>" data-rule-required="true" data-msg-required="请填写审核" id="shenhe" name="shenhe">
<option value="">请选择</option><option value="通过">通过</option>
<option value="未通过">未通过</option>

</select>
<script>
$(".class_shenhe4").val($(".class_shenhe4").attr("data-value"))</script>
                    ...
                    <td width="30" align="center">
                        <label>
                            ...
                            <?php echo $map["zulinleixing"]; ?>                        </td>
                                            <td>
                            <?php  $mapfangjianxinxi4 = db()->find("SELECT fangjianmingcheng,id FROM fangjianxinxi where id='".$map["xuanzefangjian"]."'");  ?><?php echo $mapfangjianxinxi4["fangjianmingcheng"]; ?>                        </td>
                                            <td>
