...
$map = M("zulin")->where("id" , $_GET['id'])->find();
    ...
    <div class="pa10 bg-white">
        <table class="new-detail">
            ...
            <tr>
                    ...
                    <td class="detail-value">
                        ...
                        类型                    </td>
                    <td class="detail-value">
                        <?php  $mapfangwuleixing15 = db()->find("SELECT leixing,id FROM fangwuleixing where id='".$map["leixing"]."'");  ?><?php echo $mapfangwuleixing15["leixing"]; ?>                    </td>
                                                        <td class="detail-title">
                        价格区间                    </td>
                    <td class="detail-value">
                    ...
                    <td class="detail-value">
                        ...
                        选择房间                    </td>
                    <td class="detail-value">
                        <?php  $mapfangjianxinxi16 = db()->find("SELECT fangjianmingcheng,id FROM fangjianxinxi where id='".$map["xuanzefangjian"]."'");  ?><?php echo $mapfangjianxinxi16["fangjianmingcheng"]; ?>                    </td>
                                                        <td class="detail-title">
                        租赁时长                    </td>
                    <td class="detail-value">
        ...
        <div class="new-detail-line">
            <div class="detail-title">
                备注            </div>
            <td class="detail-value">
                <pre style="padding: 5px;background: none;border: none;margin: 0;"><?php echo $map["beizhu"]; ?></pre>            </td>
        </div>
    </div>
