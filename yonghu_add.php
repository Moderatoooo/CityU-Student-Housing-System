...
<form action="yonghu.php?a=insert" method="post" name="form1" id="yonghuform1"><!-- form 标签开始 -->
    ...
    <div class="form-item-flex">
        ...
        <div class="form-label-control">
                            ...
                            <input type="text" class="form-control" placeholder="输入用户名" style="width:150px;" data-rule-required="true" data-msg-required="请填写用户名" remote="ajax.php?checktype=insert&table=yonghu&col=yonghuming" data-msg-remote="内容重复了" id="yonghuming" name="yonghuming" value=""/>                    
        </div>
...
<option value="女">女</option>
    ...
    <div class="form-item-flex">
        ...
        <div class="form-label-control">
                            ...
                            <input type="text" class="form-control" placeholder="输入年龄" style="width:150px;" id="nianling" name="nianling" value=""/>                    
        </div>
    ...
    <div class="form-item-flex">
        ...
        <div class="form-label-control">
                            ...
                            <input type="text" class="form-control" placeholder="输入所在城市" style="width:150px;" id="suozaichengshi" name="suozaichengshi" value=""/>                    
        </div>
    ...
    <div class="form-item-flex">
        ...
        <div class="form-label-control">
                            ...
                            <div class="class_nianji3" data-value=""> <label><input type="radio" id="nianji" name="nianji" value="本科"/> 本科</label> 
 ...
 <label><input type="radio" id="nianji" name="nianji" value="其他"/> 其他</label> 
    ...
    <div class="form-item-flex">
        ...
        <div class="form-label-control">
                            ...
                            <input type="text" class="form-control" placeholder="输入学院/专业" style="width:150px;" id="xueyuanzhuanye" name="xueyuanzhuanye" value=""/>                    
        </div>
