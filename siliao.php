...
if($action == 'insert'){  // 执行插入操作
    ...
    db()->query("INSERT INTO logs(module, operationtype, operationcontent, cx, username) VALUES ('私聊', '新增', '标题：".$_POST["biaoti"]."', '".$_SESSION["cx"]."', '".$_SESSION["username"]."')");


    if(isAjax()){
        showSuccess(M('siliao')->find($charuid));
    }
    ...
    db()->query("INSERT INTO logs(module, operationtype, operationcontent, cx, username) VALUES ('私聊', '更新', '标题：".$_POST["biaoti"]."', '".$_SESSION["cx"]."', '".$_SESSION["username"]."')");
    ...
    if($id){
        ...
        M($module)->delete($id);
        db()->query("INSERT INTO logs(module, operationtype, operationcontent, cx, username) VALUES ('私聊', '删除', '标题：".$map["biaoti"]."', '".$_SESSION["cx"]."', '".$_SESSION["username"]."')");
