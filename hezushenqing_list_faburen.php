...
<div class="form-search pa10 bg-warning">
    <form class="form-inline" action="?" size="small" id="formSearch"><!-- form 标签开始 -->
                   ...
                   类型： <select class="form-control class_leixing6" data-value="<?php echo $_GET["leixing"]; ?>" id="leixing" name="leixing">
...
<script>
$(".class_leixing6").val($(".class_leixing6").attr("data-value"))</script>

                    
                   设施： <select class="form-control class_sheshi7" data-value="<?php echo $_GET["sheshi"]; ?>" id="sheshi" name="sheshi[]">
...
(function(){
                            ...
                            for(var i=0;i<dataValue.length;i++){
                                $(".class_sheshi7>option[value='"+dataValue[i]+"']").prop("selected" , true);
                            }
                        })()</script>

                    
                   是否有电梯： <select class="form-control class_shifouyoudianti8" data-value="<?php echo $_GET["shifouyoudianti"]; ?>" id="shifouyoudianti" name="shifouyoudianti">
<option value="">请选择</option><option value="是">是</option>
<option value="否">否</option>

</select>
<script>
$(".class_shifouyoudianti8").val($(".class_shifouyoudianti8").attr("data-value"))</script>

                    
                   租赁类型： <select class="form-control class_zulinleixing9" data-value="<?php echo $_GET["zulinleixing"]; ?>" id="zulinleixing" name="zulinleixing">
<option value="">请选择</option><option value="整租">整租</option>
<option value="分租">分租</option>

</select>
<script>
$(".class_zulinleixing9").val($(".class_zulinleixing9").attr("data-value"))</script>
                   ...
                   合租状态： <select class="form-control class_hezuzhuangtai10" data-value="<?php echo $_GET["hezuzhuangtai"]; ?>" id="hezuzhuangtai" name="hezuzhuangtai">
...
<script>
$(".class_hezuzhuangtai10").val($(".class_hezuzhuangtai10").attr("data-value"))</script>
