...
<?php             // 获取当前用户得数据
        $mmm = M('fangdong')->where('id' , $_SESSION['id'])->find();
...
<form action="fangdong.php?a=update" method="post" name="form1" id="fangdongform1"><!-- form 标签开始 -->
    ...
    <div class="form-item-flex">
        ...
        <div class="form-label-control">
                            ...
                            <select class="form-control class_xingbie2" data-value="<?php echo Info::html($mmm["xingbie"]); ?>" data-rule-required="true" data-msg-required="请填写性别" id="xingbie" name="xingbie" style="width:250px">
