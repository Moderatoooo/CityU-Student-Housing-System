            ...
            <div class="panel-body">
                ...
                <div class="form-search pa10 bg-warning">
                    <form class="form-inline" action="?" size="small" id="formSearch"><!-- form 标签开始 -->
                        ...
                        押金方式： <select class="form-control class_yajinfangshi1"
                        ...
                        <script>
                            $(".class_yajinfangshi1").val($(".class_yajinfangshi1").attr("data-value"))</script>


                        类型： <select class="form-control class_leixing2" data-value="<?php echo $_GET["leixing"]; ?>"
                        ...
                        <script>
                            $(".class_leixing2").val($(".class_leixing2").attr("data-value"))</script>


                        价格区间： <select class="form-control class_jiagequjian3"
                        ...
                        <script>
                            $(".class_jiagequjian3").val($(".class_jiagequjian3").attr("data-value"))</script>


                        距离学校： <select class="form-control class_julixuexiao4"
                        ...
                        <script>
                            $(".class_julixuexiao4").val($(".class_julixuexiao4").attr("data-value"))</script>


                        设施： <select class="form-control class_sheshi5" data-value="<?php echo $_GET["sheshi"]; ?>"
                        ...
                        <script>
                            (function () {
                                ...
                                for (var i = 0; i < dataValue.length; i++) {
                                    $(".class_sheshi5>option[value='" + dataValue[i] + "']").prop("selected", true);
                                }
                            })()</script>


                        是否有电梯： <select class="form-control class_shifouyoudianti6"
                        ...
                        <script>
                            $(".class_shifouyoudianti6").val($(".class_shifouyoudianti6").attr("data-value"))</script>


                        租赁类型： <select class="form-control class_zulinleixing7"
                        ...
                        <script>
                            $(".class_zulinleixing7").val($(".class_zulinleixing7").attr("data-value"))</script>
