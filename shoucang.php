...
if($action == 'insert'){  // 执行插入操作
    ...
    db()->query("UPDATE fangwuxinxi SET shoucangliang = shoucangliang+1 WHERE id='".$_POST["xwid"]."'");


    if(isAjax()){
        showSuccess(M('shoucang')->find($charuid));
    }
