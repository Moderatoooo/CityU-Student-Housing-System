...
if ($_GET["leixing"] != null && !"" == $_GET["leixing"]) {
    $where .= " AND leixing LIKE '%" . $_GET["leixing"] . "%'";
}

// 构建fangwuleixing数据模型
$query = M("fangwuleixing");
// 设置所有字段
$query->field("*");
                    ...
                    <table width="100%" border="1" class="table table-list table-bordered table-hover">
                        ...
                        foreach ($lists as $map) {
                            ...
                            <tr id="<?php echo $map["id"]; ?>" pid="">
                                ...
                                <td>
                                    <?php echo $map["leixing"]; ?>                        </td>

                                <td align="center">
                                    <a class="btn btn-success btn-xs"
                                       href="fangwuleixing_updt.php?id=<?php echo $map["id"]; ?>" title="编辑"> 编辑 </a>


                                    <a class="btn btn-danger btn-xs"
                                       href="fangwuleixing.php?a=delete&id=<?php echo $map["id"]; ?>"
