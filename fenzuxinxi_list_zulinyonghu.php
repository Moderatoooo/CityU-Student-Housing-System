            ...
            <div class="panel-body">
                ...
                <div class="form-search pa10 bg-warning">
                    <form class="form-inline" action="?" size="small" id="formSearch"><!-- form 标签开始 -->
                        ...
                        押金方式： <select class="form-control class_yajinfangshi15"
                        ...
                        <script>
                            $(".class_yajinfangshi15").val($(".class_yajinfangshi15").attr("data-value"))</script>


                        类型： <select class="form-control class_leixing16" data-value="<?php echo $_GET["leixing"]; ?>"
                        ...
                        <script>
                            $(".class_leixing16").val($(".class_leixing16").attr("data-value"))</script>


                        价格区间： <select class="form-control class_jiagequjian17"
                        ...
                        <script>
                            $(".class_jiagequjian17").val($(".class_jiagequjian17").attr("data-value"))</script>


                        距离学校： <select class="form-control class_julixuexiao18"
                        ...
                        <script>
                            $(".class_julixuexiao18").val($(".class_julixuexiao18").attr("data-value"))</script>


                        设施： <select class="form-control class_sheshi19" data-value="<?php echo $_GET["sheshi"]; ?>"
                        ...
                        <script>
                            (function () {
                                ...
                                for (var i = 0; i < dataValue.length; i++) {
                                    $(".class_sheshi19>option[value='" + dataValue[i] + "']").prop("selected", true);
                                }
                            })()</script>


                        是否有电梯： <select class="form-control class_shifouyoudianti20"
                        ...
                        <script>
                            $(".class_shifouyoudianti20").val($(".class_shifouyoudianti20").attr("data-value"))</script>


                        租赁类型： <select class="form-control class_zulinleixing21"
                        ...
                        <script>
                            $(".class_zulinleixing21").val($(".class_zulinleixing21").attr("data-value"))</script>
                ...
                <div class="list-table">
                    <table width="100%" border="1" class="table table-list table-bordered table-hover">
                        ...
                        <tr align="center">
                            ...
                            <th width="80" data-field="issh">是否上架</th>
                        ...
                        foreach ($lists as $map) {
                            ...
                            <tr id="<?php echo $map["id"]; ?>" pid="">
                                ...
                                <td>
                                    <?php echo $map["issh"]; ?>
                                    <a href="action.php?a=sh&id=<?php echo $map["id"]; ?>&yuan=<?php echo $map["issh"]; ?>&tablename=fenzuxinxi">
                                        <?php if ($map["issh"] == "是") { ?>
                                            下架
                                        <?php } else { ?>
                                            上架
                                ...
                                <td align="center">
                                    ...
                                    <a class="btn btn-success btn-xs"
                                       href="fenzuxinxi_updt.php?id=<?php echo $map["id"]; ?>" title="编辑"> 编辑 </a>


                                    <a class="btn btn-danger btn-xs"
                                       href="fenzuxinxi.php?a=delete&id=<?php echo $map["id"]; ?>"
